...
[Harry Stevens (2020), [Why outbreaks like coronavirus spread exponentially, and how to “flatten the curve”](https://www.washingtonpost.com/graphics/2020/world/corona-simulator/), <em>The Financial Times</em>](img/covid-simulation.gif)
...
### {data-background-iframe="https://coronavirus.jhu.edu/map.html" data-transition="fade-in slide-out"}

<span class="source" style="margin-top:600px;">COVID-19 Dashboard by the Center for Systems Science and Engineering (CSSE) at Johns Hopkins University (JHU)</span>
