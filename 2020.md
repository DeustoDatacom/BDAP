...
<!-- ADD THIS AS NOTES TO COVER SLIDE, SOME TIME
     - My name, title.
     - From the Department of Communication, teach digital communication to undergraduate students
     - Not going to deal with the technicalities of dataviz;
     - instead, because dataviz is made to transmit data to **people**, and that makes it part of a communication process, we are going to focus on that aspect and the implications it has on design decisions
     - So I don't really expect to teach you anything about statistical processing or programming for dataviz (this is not a technical session), but I do hope to convince you on the need to devote some time (at least the time we will be together this afternoon) to raise your heads up a bit, look at your data with different eyes, and also give you some arguments to think about it more reflectively, and also about how best to tell it to your audience.
-->
...
![Harry Stevens (2020), Why outbreaks like coronavirus spread exponentially, and how to “flatten the curve”, _The Financial Times_](img/covid-simulation.gif)
...
<!-- @jburnmurdoch (2020/10/30), [from Twitter](https://twitter.com/jburnmurdoch/status/1322232057494470659) -->

###  {data-transition="fade"}

![from Twitter](img/covid-crop-tweet2.png)

<!-- @jburnmurdoch (2020/10/30), [from Twitter](https://twitter.com/jburnmurdoch/status/1322233068791410691) -->
